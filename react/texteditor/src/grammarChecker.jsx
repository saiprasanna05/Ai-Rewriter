    ...
    useEffect(() => {
        const timer = setTimeout(async () => {
            ...
            try {
                ...
                const newvalue = data;
                (data) ? responseset(true) : responseset(false);
        ...
        <>
            {
                (response) ? output.map((x) => {
                    ...
                    return ( // ✅ Added return statement
                        <div key={x.id} className="grammer">
